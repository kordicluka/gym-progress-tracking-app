// @/app/(authenticated)/body-measurements-and-goals/page.tsx
import BodyStatsAndGoalForm from "@/components/BodyStatsAndGoalForm";
import Image from "next/image";

export default function BodyStatsAndGoalPage() {
  return (
    <main className="absolute z-50  top-0 left-0 w-full h-screen overflow-hidden bg-black flex flex-col xl:flex-row items-start justify-start">
